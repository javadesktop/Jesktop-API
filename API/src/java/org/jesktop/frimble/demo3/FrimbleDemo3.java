...
public class FrimbleDemo3 extends JPanel implements FrimbleAware {
    ...
    public void setFrimble(Frimble f) {
        ...
        f.setTitle(
            "This Demo works in 1) Jesktop, 2) Java Web Start and 3) from the command line");
    ...
    public static void main(String[] args) {
        ...
        Frimble frimble = JFrameFrimble.createJFrameFrimble(new JFrame("FrimbleDemo3"));

        frimble.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frimble.getContentPane().setLayout(new BorderLayout());

        FrimbleDemo3 fd = new FrimbleDemo3();
